...
console.log('tyrannosaurus ' + tyrannosaurus.roar());
...
// const uni = [];
//* Stretch included
const uni = universities.filter(word => word.includes('Uni'));
if (uni.length>0) {
console.log(`${uni.length} universities have "Uni" string included in their names`  );
console.log(uni);
}
else {
 console.log('There is no university name with "Uni" string');
};
...
*/
// const lowerCase = animalNames.map((animalobj) => {
//   return animalobj.Name.toLowerCase();
// });
//Stretch ***
const lowerCase = animalNames.map(animalobj => animalobj.Name.toLowerCase());                        
...
*/
//Stretch included ***
const lowerPopulation = zooAnimals.filter(animalobj => animalobj.population < 5);
...
// const populationTotal = zooAnimals.reduce((total,data) => { 
//   return total += data.population;},0);
//Stretch ****
const populationTotal = zooAnimals.reduce((total,data) => total += data.population,0);
console.log("populationTotal is : " + populationTotal);  
